...
const Teachers = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://arjun-academy-4c7g.onrender.com/teachers") // Your backend URL
      .then((response) => {
            ...
            <div key={index} className="col-xl-3 col-lg-3 col-md-6 mb-4">
              <div className="single-team text-center mt-30">
                <div className="team-thumb">
                  ...
                  <img
                    src={`https://arjun-academy-4c7g.onrender.com/${member.image}`} // Reference the correct backend URL
                    alt={member.name}
                    className="img-fluid"
                  />
                </div>
